    ...
    <div   className='flex justify-center'>
          <div className="bg-slate-200  p-4 mt-10 mb-4 mx-2 flex flex-col rounded  items-center" style={{ width: "14rem" }}>
            ...
            <div className="card-body">
                  ...
                  <Link to={`/product/${product.id}`} onClick={handleProductDetails}  className='underline font-bold my-1 text-sky-500 hover:text-sky-800 ease-in duration-300'>View Details</Link>
